    ...
    fileButton.addEventListener('change', function(e) {
        ...
        storageRef.getDownloadURL().then(function(url) {
            ...
            var downloaduri = url;
            var pdfImage = "https://user-images.githubusercontent.com/7325075/26889488-f58c9e6e-4b73-11e7-926e-7ecb7e69aaa9.png"


            $("#lblFile").html("<a href=" + downloaduri + "><img 'class=img-thumbnail height=150px width=150px src=" + pdfImage + "></a><br><br>"); //store this url for opening the file
